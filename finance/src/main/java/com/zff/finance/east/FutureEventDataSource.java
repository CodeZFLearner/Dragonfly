 ...
 */
public class FutureEventDataSource extends AbstractDataSource {
    ...
    public FutureEventDataSource(DataSink sink) {
        super(sink);
    }
    ...
    private List<StandardRecord> parseResponseData(String jsonStr) {
        ...
        if (byPath instanceof JSONArray) {
            ...
            for (int i = 0; i < dataList.size(); i++) {
                ...
                resultList.add(FutureEventVo.toStandardRecord(jsonObject));
            }
        }
    ...
    public static void main(String[] args) {
        new FutureEventDataSource(null).run();
    }
}
