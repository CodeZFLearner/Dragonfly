 ...
 */
public class ShareChangeDataSource extends AbstractDataSource {

    private static final Logger logger = LoggerFactory.getLogger(ShareChangeDataSource.class);
     ...
     * 构造函数
     */
    public ShareChangeDataSource(DataSink sink) {
        super(sink);
    }
    ...
    public static void main(String[] args) {
        new ShareChangeDataSource(null).run();
    }
}
