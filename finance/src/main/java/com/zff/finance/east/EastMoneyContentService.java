...
public class EastMoneyContentService {
     ...
     * 获取新闻列表 (HandleNews)
     */
    public NewsResponse handleNews(String midCode, Integer pageSize) {
     ...
     * 获取股吧帖子内容 (guba)
     */
    public static GubaResponse getGubaPost(String postId) {
     ...
     * 获取董秘问答 (QA)
     */
    public QAResponse getQA(String code, Integer pageSize) {
